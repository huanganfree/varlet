import{_ as r,b as c,e as o,m as h,p as s,q as l,w as n,Q as a,Z as p}from"./index-ba2bae36.js";const i={components:{}},d={class:"varlet-site-doc"},j=s("h1",null,"样式定制",-1),u={class:"card"},m={id:"jie4shao4"},_=s("p",null,[a("组件库通过 "),s("a",{href:"https://developer.mozilla.org/zh-CN/docs/Web/CSS/Using_CSS_custom_properties"},"css 变量"),a(" 来组织样式，每个组件都有对应的样式变量， 您可以通过 css 文件覆盖的方式直接替换根节点上的样式变量, 或者使用 StyleProvider 组件。")],-1),g={class:"card"},b={id:"ji1ben3yang4shi4bian4liang4"},y=s("p",null,"以下是组件库一些基本的样式变量。",-1),v=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-selector-pseudo"},":root"),a(` {
...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),T={class:"card"},C={id:"han2shu4shi4diao4yong4"},N=s("p",null,[a("函数式的调用是直接更新 "),s("code",null,":root"),a(" 上的变量，适合需要全局更新样式的情况。")],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),$=s("h2",null,"API",-1),B={class:"card"},R={id:"shu3xing4"},q=p("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>style-vars</code></td><td>CSS 变量</td><td><em>Record&lt;string, string&gt;</em></td><td><code>{}</code></td></tr><tr><td><code>tag</code></td><td>自定义标签名</td><td><em>string</em></td><td><code>div</code></td></tr></tbody></table>",1),A={class:"card"},E={id:"cha1cao2"},I=s("table",null,[s("thead",null,[s("tr",null,[s("th",null,"插槽名"),s("th",null,"说明"),s("th",null,"参数")])]),s("tbody",null,[s("tr",null,[s("td",null,[s("code",null,"default")]),s("td",null,"组件内容"),s("td",null,[s("code",null,"-")])])])],-1);function Q(U,W,Z,D,F,G){const t=c("router-link"),e=c("var-site-code-example");return o(),h("div",d,[j,s("div",u,[s("h3",m,[l(t,{to:"#jie4shao4"},{default:n(()=>[a("#")]),_:1}),a("介绍")]),_]),s("div",g,[s("h3",b,[l(t,{to:"#ji1ben3yang4shi4bian4liang4"},{default:n(()=>[a("#")]),_:1}),a("基本样式变量")]),y,l(e,{"playground-ignore":""},{default:n(()=>[v]),_:1})]),s("div",f,[s("h3",x,[l(t,{to:"#yun4xing2shi2xiu1gai3yang4shi4"},{default:n(()=>[a("#")]),_:1}),a("运行时修改样式")]),k]),s("div",w,[s("h3",S,[l(t,{to:"#zu3jian4shi4diao4yong4"},{default:n(()=>[a("#")]),_:1}),a("组件式调用")]),z,l(e,null,{default:n(()=>[V]),_:1})]),s("div",T,[s("h3",C,[l(t,{to:"#han2shu4shi4diao4yong4"},{default:n(()=>[a("#")]),_:1}),a("函数式调用")]),N,l(e,null,{default:n(()=>[P]),_:1})]),$,s("div",B,[s("h3",R,[l(t,{to:"#shu3xing4"},{default:n(()=>[a("#")]),_:1}),a("属性")]),q]),s("div",A,[s("h3",E,[l(t,{to:"#cha1cao2"},{default:n(()=>[a("#")]),_:1}),a("插槽")]),I])])}const J=r(i,[["render",Q]]);export{J as default};
